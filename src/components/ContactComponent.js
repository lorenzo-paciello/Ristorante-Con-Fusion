                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="text" id="firstname" name="firstname" 
                                       ...
                                       onBlur={this.handleBlur('firstname')} onChange={this.handlerInputChange} />
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="text" id="lastname" name="lastname" 
                                       ...
                                       onBlur={this.handleBlur('lastname')} onChange={this.handlerInputChange} />
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="tel" id="telnum" name="telnum"
                                       ...
                                       onBlur={this.handleBlur('telnum')} onChange={this.handlerInputChange} />
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="text" id="email" name="email" 
                                       ...
                                       onBlur={this.handleBlur('email')} onChange={this.handlerInputChange} />
                                ...
                                <FormGroup check>
                                    <Label check>
                                        <Input type="checkbox" name="agree"
                                               checked={this.state.agree} onChange={this.handlerInputChange} />{' '}<strong>May we contact you</strong>
                                    </Label>
                                </FormGroup>
                            </Col>
                            <Col md={{size:3, offset: 1}}>
                                <Input type="select" name="contactType" 
                                       value={this.state.contactType} onChange={this.handlerInputChange}>
                                    <option>Tel.</option>
                                    <option>Email</option>
                                </Input>
                            </Col>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="textarea" id="message" name="message" 
                                       rows="12" value={this.state.message} onChange={this.handlerInputChange}/>
                            </Col>
                        </FormGroup>
                        <FormGroup row>
